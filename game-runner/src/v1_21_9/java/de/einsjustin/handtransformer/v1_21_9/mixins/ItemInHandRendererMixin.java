...
public abstract class ItemInHandRendererMixin {
  ...
  private void callRenderRightHandEvent(AvatarRenderer instance, PoseStack poseStack,
      SubmitNodeCollector submitNodeCollector, int i0, ResourceLocation resourceLocation, boolean b) {
    this.hand_transformer$stack = ((VanillaStackAccessor) poseStack).stack(submitNodeCollector);
    ...
    var renderer = (AvatarRenderer) this.entityRenderDispatcher.getRenderer(abstractClientPlayer);
